...
from mapper.falkordb_client import FalkorDBClient
...
class GraphRepository:
    ...
    def __init__(self, use_falkordb: bool = False, falkordb_url: str = "redis://localhost:6379/0") -> None:
        self._normalized_graph_inputs: dict[str, NormalizedGraph] = {}
    ...
    def save_graph_input(self, graph_id: str, graph: NormalizedGraph) -> None:
        self._normalized_graph_inputs[graph_id] = graph

    def get_graph_input(self, graph_id: str) -> NormalizedGraph | None:
        return self._normalized_graph_inputs.get(graph_id)
