...
from domain.models import ALLOWED_ENTITY_RELATIONS, GraphInput


class GraphParser:
    """Parse and validate graph payloads."""

    def parse(self, raw_json: dict[str, Any]) -> GraphInput:
        ...
        graph = GraphInput.model_validate(canonical)
        self._validate_cross_refs(graph)
        return graph
    ...
    def _validate_cross_refs(self, graph: GraphInput) -> None:
